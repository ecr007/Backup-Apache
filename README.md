...
# LoadModule php5_module /usr/local/php5-5.5.38/libphp5.so
# LoadModule php5_module /usr/local/php5-5.6.36/libphp5.so
LoadModule php7_module /usr/local/php5-7.3.8/libphp7.so
